...
from scraping.fixtures_footballdata import fetch_fixtures_fd
from utils.config import HOME_ADV_ELO, DRAW_NU, FOOTBALLDATA_KEY
...
def main():
    ...
    try:
        f_count = fetch_fixtures_fd(args.leagues, date_from, date_to, token=FOOTBALLDATA_KEY, season_label="2025/2026")
        logger.info(f'Fixtures hentet (football-data): {f_count}')
